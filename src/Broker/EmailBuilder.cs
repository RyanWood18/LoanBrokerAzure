...
namespace Broker
{
    ...
    {
        private static string BuildQuotesTable(List<QuotationAggregator.Quotation> quotes)
        {
        ...
        public static string BuildEmail(List<QuotationAggregator.Quotation> quotes)
        {
            var builder = new StringBuilder();
